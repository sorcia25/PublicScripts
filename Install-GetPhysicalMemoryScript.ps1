## Este script lo utilizo en Azure Run Command (debajo de operations), para inyectar el script Get-PhysicalMemory.ps1
## y crear la tarea calendarizada para el mismo.
##
## Crear certificado autofirmado para Code Signing y firmar el codigo para obtener la memoria de forma segura
